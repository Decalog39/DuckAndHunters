...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        public virtual void OnStartServer() {
            ...
            string gameManagerPrefabPath = "Prefabs/GameManager";
            GameObject gameManagerPrefab = Resources.Load<GameObject>(gameManagerPrefabPath);
            GameObject gameManagerObject = Instantiate(gameManagerPrefab);

            // Spawn the GameManager object on the server
